...
public final class SurfaceControl implements Parcelable {
    ...
    private static native void nativeSetIndex(long transactionObj, long nativeObject, float index);
    ...
    public static class Transaction implements Closeable, Parcelable {
        ...
        @NonNull
        public Transaction setIndex(@NonNull SurfaceControl sc,
                @FloatRange(from = 0.0, to = 1.0) float index) {
            checkPreconditions(sc);
            nativeSetIndex(mNativeObject, sc.mNativeObject, index);
            mIndex = index;
