...
public class BatAnimation extends Animation {
    ...
    /**
     * Constructor used when a BatAnimation is loaded from a resource.
     *
     * @param context Application context to use
     * @param attrs Attribute set from which to read values
     */
    public BatAnimation(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     *        animation
     */
    public BatAnimation(float fromXDelta, float toXDelta, float fromYDelta, float toYDelta) {
     ...
     *        is ABSOLUTE, or a percentage (where 1.0 is 100%) otherwise.
     */
    public BatAnimation(int fromXType, float fromXValue, int toXType, float toXValue,
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {
        ...
        t.setIndex(interpolatedTime);
        // t.setAlpha(interpolatedTime);
        // Slog.w("BAT", "BatAnimation set index " + interpolatedTime);
    }
